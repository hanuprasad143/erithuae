  ...
  return (
    <section className="school-area grey-bg fix pb-120">
      <div className="container">
        <div
          className="tp-school-4-bg wow fadeInUp"
          data-wow-delay=".3s"
          data-background="assets/img/bg/school-4-bg-1.jpg"
        >
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="tp-school-4-wrap">
                  <h4 className="tp-school-4-title">
                    Why Enrol at <br /> Virtual High{" "}
                    <span>
                      School?
                      <svg
                  ...
                  <div className="tp-school-4-list">
                    <ul>
                      ...
                      <li>
                        Established reputation with colleges and universities
                      </li>
